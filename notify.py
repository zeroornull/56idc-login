...
push_config = {
    ...
    'BARK_PUSH': os.getenv('BARK_PUSH', ''),                    # bark IP 或设备码，例：https://api.day.app/DxHcxxxxxRxxxxxxcm/
    'BARK_ARCHIVE': os.getenv('BARK_ARCHIVE', ''),                 # bark 推送是否存档
    'BARK_GROUP': os.getenv('BARK_GROUP', ''),                   # bark 推送分组
    'BARK_SOUND': os.getenv('BARK_SOUND', ''),                   # bark 推送声音
    'BARK_ICON': os.getenv('BARK_ICON', ''),                    # bark 推送图标
    'BARK_LEVEL': os.getenv('BARK_LEVEL', ''),                   # bark 推送时效性
    'BARK_URL': os.getenv('BARK_URL', ''),                     # bark 推送跳转URL

    'CONSOLE': False,                    # 控制台输出

    'DD_BOT_SECRET': os.getenv('DD_BOT_SECRET', ''),                # 钉钉机器人的 DD_BOT_SECRET
    'DD_BOT_TOKEN': os.getenv('DD_BOT_TOKEN', ''),                 # 钉钉机器人的 DD_BOT_TOKEN

    'FSKEY': os.getenv('FSKEY', ''),                        # 飞书机器人的 FSKEY
    ...
    'PUSH_PLUS_TOKEN': os.getenv('PUSH_PLUS_TOKEN', ''),              # push+ 微信推送的用户令牌
    'PUSH_PLUS_USER': os.getenv('PUSH_PLUS_USER', ''),               # push+ 微信推送的群组编码
    ...
    'TG_BOT_TOKEN': os.getenv('TG_BOT_TOKEN') or os.getenv('TELEGRAM_BOT_TOKEN') or '',                 # tg 机器人的 TG_BOT_TOKEN
    'TG_USER_ID': os.getenv('TG_USER_ID') or os.getenv('TELEGRAM_CHAT_ID') or '',                   # tg 机器人的 TG_USER_ID
